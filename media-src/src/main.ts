...
function initVditor(msg) {
  ...
  window.vditor = new Vditor('app', {
    ...
    upload: {
      url: '/fuzzy', // without the url parameter, pasted images can't be uploaded, see: https://github.com/Vanessa219/vditor/blob/d7628a0a7cfe5d28b055469bf06fb0ba5cfaa1b2/src/ts/util/fixBrowserBehavior.ts#L1409
      async handler(files) {
